...
public:
    ...
    void allocate(int u, MyUeList my_UE_list, RfDataRateMatrix RF_data_rate_matrix);
    void allocate(int u, MyUeList my_UE_list, VlcDataRateMatrix VLC_data_rate_matrix);
