...
void My_UE_Node::SetPosition(Vector pos_from_mobilitymodel)
{
...
void My_UE_Node::Set_Required_DataRate(double data_rate_in_Mbps)
{
...
void My_UE_Node::Set_Avg_Throughput(double data_rate_in_Mbps)
{
...
void My_UE_Node::Set_Now_Associated_AP(int associated_AP_index)
{
    prev_associated_AP = now_associated_AP;
    now_associated_AP = associated_AP_index;
}

int My_UE_Node::Get_Now_Associated_AP(void)
{
    return now_associated_AP;
}

void My_UE_Node::Set_Time_Fraction(double timefrac)
{
...
int My_UE_Node::Get_Prev_Associated_AP(void)
{
    return prev_associated_AP;
}

void My_UE_Node::Set_SINR(double in_SINR)
{
    SINR = in_SINR;
}
...
void My_UE_Node::Add_Curr_iteration_Throughput(double data_rate_in_Mbps)
{
...
void My_UE_Node::Add_Curr_satisfication_level(double satis_level)
{
