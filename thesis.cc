...
LoadBalanceMethod *benchmark_method = new BenchmarkLoadBalanceMethod();
LoadBalanceMethod *proposed_method = new ProposedLoadBalanceMethod();
								 ...
								 NodeContainer &UE_Nodes, MyUeList &my_UE_list)
{
	...
	proposed_method->execute(state, RF_AP_Nodes, VLC_AP_Nodes, UE_Nodes,
	...
	benchmark_method->execute(state, RF_AP_Nodes, VLC_AP_Nodes, UE_Nodes,
						RF_Channel_Gain_Matrix, VLC_Channel_Gain_Matrix,
						RF_SINR_Matrix, VLC_SINR_Matrix,
						RF_data_rate_matrix, VLC_data_rate_matrix,
						Handover_efficiency_matrix, AP_association_matrix, TDMA_matrix, my_UE_list);
